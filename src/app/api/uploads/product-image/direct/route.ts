...
export async function POST(req: NextRequest) {
  try {
    ...
    const categoryId = typeof categoryIdRaw === 'string' && /^\d+$/.test(categoryIdRaw)
      ? categoryIdRaw
      : 'uncategorized';
    ...
    const key = `products/${categoryId}/${slug}/image`;
    ...
    console.error('POST /api/uploads/product-image/direct', err);
